package com.martinatanasov.icecold.listeners;


import com.martinatanasov.icecold.config.KafkaConfig;
...
@EmbeddedKafka(controlledShutdown = true,
        topics = {KafkaConfig.DRINK_PREPARED_TOPIC, KafkaConfig.DRINK_REQUEST_ICE_COLD_TOPIC},
